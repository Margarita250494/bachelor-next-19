    ...
    <>
      ...
      >
        <div className="w-full px-0 l:w-[60%] l:px-8">
          <h4
            className="mb-3 text-gray-600 font-serif text-[20px] xs:text-[22px] font-bold tracking-[0.7px]"
          >❤️ Health comes first
          </h4>
          <h1
            className="w-full l:w-125 font-sans text-[28px] xs:text-[40px] font-bold"
          >
            Find your Doctor and make an Appointments
          </h1>
          <Description
            variant="hero"
            description="Talk to online doctors and get medical advice, online prescriptions,refills and medical notes within minutes. On-demand healthcare services at your fingertips."
          />
          <MainButton
          ...
          <ul className="flex items-center gap-4.5 xs:gap-12 mt-10">
            {infoHero.map(({id, number, desc}) => (
              ...
              >
                ...
                <p className="text-gray-600 font-sans text-[16px] xs:text-[22px] tracking-[0.7px]">{desc}</p>
              </li>
            ))}
          </ul>
        </div>
