  ...
  return (
    ...
    >
      <div className="">
        ...
        <h3
          className="my-4 font-serif text-[28px] s:text-[36px] font-bold tracking-[0.7px] leading-[2.6rem]">
        ...
        <p className="my-16 flex items-center relative">
          <Quote isEnd={false} />
          <span
            className="block ml-2 font-serif text-[22px] s:text-[24px] tracking-[0.7px] leading-[1.8rem] s:leading-[2.2rem]"
        ...
        <div className="ml-2 flex flex-wrap justify-between items-center">
          <div>
            ...
            <p
              className="mt-1.5 text-gray-400 font-serif text-[18px] font-bold tracking-[0.8px]"
